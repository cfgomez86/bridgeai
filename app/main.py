...
from app.api.routes import admin_incoherent_requirements as admin_incoherent_requirements_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(admin_incoherent_requirements_router.router, prefix="/api/v1", tags=["admin"])
