...
def insert_story(db, story_id: str = "story-harden-1") -> UserStoryModel:
    ...
    story = UserStoryModel(
        ...
        subtasks=json.dumps({"frontend": [], "backend": [{"title": "Task1", "description": "Do the thing."}], "configuration": []}),
...
def make_domain_story() -> UserStory:
    return UserStory(
        ...
        subtasks={"frontend": [], "backend": [{"title": "Task1", "description": "Do the thing."}], "configuration": []},
